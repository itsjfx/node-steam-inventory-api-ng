...
class InventoryAPI extends EventEmitter {
	 ...
	 * @param {number} retries - The number of times to retry calling an inventory before rejecting. If an inventory is private or not found this value is ignored and an error is thrown after the first request.
	 * @param {string} language - The language of item descriptions to return (default: 'english')
